...
exports.takeActionForJob = async (req, res) => {
    try {
        ...
        if (findAppliesData) {
            ...
            let filePath = 'D:/teach-lancer/backEnd/views/jobInterviewMail.ejs'
...
exports.takeActionForIntern = async (req, res) => {
    try {
        ...
        if (findAppliesData) {
            ...
            let filePath = 'D:/teach-lancer/backEnd/views/internInterviewMail.ejs'
    ...
    try {
        ...
        if (findAppliesData) {
            ...
            if (req.body.status == 3) {
                 ...
                 let content = { "userName": findAppliesData.username, "companyName" : findAppliesData.company_name };
                 let filePath = 'D:/teach-lancer/backEnd/views/hiredMail.ejs'
                ...
                let content = { "userName": findAppliesData.username, "companyName" : findAppliesData.company_name };
                let filePath = 'D:/teach-lancer/backEnd/views/rejectionMail.ejs'
